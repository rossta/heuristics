...
describe Mint::Exchange do
  ...
  describe "equal" do
    it "should return total exact change of 328 with coin set 1, 5, 16, 23, 33" do
      exact_change = Mint::Exchange.new(1)
      exact_change.calculate!
      exact_change.results.should == 328
  ...
  #       exact_change = Mint::Exchange.new(3)
  #       exact_change.calculate!
  ...
  #       exact_change = Mint::Exchange.new(4)
  #       exact_change.calculate!
  ...
  #       exact_change = Mint::Exchange.new(5)
  #       exact_change.calculate!
  ...
  #       exact_change = Mint::Exchange.new(100)
  #       exact_change.calculate!
  ...
  #       exact_change = Mint::Exchange.new(2398172398)
  #       exact_change.calculate!
  ...
  #       exact_change = Mint::Exchange.new(0.01)
  #       exact_change.calculate!
  ...
  #     it "should return total exact change of 261 with coin set 1, 4, 9, 29, 44" do
  #       exact_change = Mint::Exchange.new(0.00231)
  #       exact_change.calculate!
  #       exact_change.results.should == 261
  #       exact_change.coin_set.should == [1, 4, 9, 29, 44]
  #     end
